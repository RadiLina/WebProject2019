...
<head>
    ...
    <title>Titre contribution</title>
	<!-- BOOTSTRAP STYLES-->
...
<!-- ajouter pour la couleur du Checkbox -->
.checkbox {
  color: green;
...
<!-- /. NAV SIDE  -->
  ...
  <!-- LA PARTIE SE CONNECTER -->           
          ...
          <div class="field half firstAuthentification">
							...
							<label for="name">Titre contribution: </label>
							<textarea name="titreContribution"  style="width:650px;height:300px;" required > </textarea>
			...
			<input type="hidden" name="pageName" value="AjouterTitreContribution">
						<ul class="actions">
