...
<head>
    ...
    <title>Ajouter un contributeur</title>
	<!-- BOOTSTRAP STYLES-->
...
<!-- /. NAV SIDE  -->
  ...
  <!-- LA PARTIE SE CONNECTER -->           
          ...
          <div class="field half firstAuthentification">
							...
							<li><input type="number" id="codeInterne" name="codeInterne" value=""  placeholder="Entrez le code interne" pattern="[0-9]{4}" required></li>
			...
			<input type="hidden" name="pageName" value="toAjouter">
						<ul class="actions">
							<li><input id="Submit" value="Valider" class="button alt" type="submit"></li>
						</ul>
