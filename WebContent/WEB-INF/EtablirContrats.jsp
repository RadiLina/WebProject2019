                  		...
                  		<div class="table-responsive">
                            <table class="table">
                                ...
                                for(int i=0;i<contributeurs.size();i++){
                                	...
                                	if(contributeurs.get(i).getPau_titre_contrib()!=null){ 
                                    	out.println("<td><a href=\"Servlet?pageName=EtablirContrat&projetId="+contributeurs.get(i).getPau_prj_id()+"&tierId="+contributeurs.get(i).getPau_tie_id()+"\" class=\"btn btn-success\">Etablir le contrat</a></td>");     
                                    	 }else{
                                    		 out.println("<td>"+"/"+"</td>");
                                    	 }
